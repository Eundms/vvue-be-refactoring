...
class ScheduledNotificationTest {
  ...
  public void reserveBirthday() {
    ...
    Schedule schedule = Schedule.builder()
        ...
        .married(
            Married.builder()
                .first(User.builder().id(3L).birthday(LocalDate.of(1999, 8, after.getDayOfMonth()))
                    .build())
                .second(User.builder().id(4L).birthday(LocalDate.of(1992, 8, after.getDayOfMonth()))
                    .build())
                .build()
        )
    ...
    NotificationType notificationType = null;
    List<Long> receiverIds = new ArrayList<>();
    if (schedule.getDateType() == DateType.MALEBIRTHDAY
