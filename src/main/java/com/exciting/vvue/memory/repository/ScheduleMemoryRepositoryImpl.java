...
public class ScheduleMemoryRepositoryImpl implements ScheduleMemoryRepository {
  ...
  @Override
  public ScheduleMemory findByScheduleIdAndMarriedIdAndDate(Long scheduleId, Long userMarriedId,
      LocalDate day) {
    return scheduleMemoryJpaRepository.findByScheduleIdAndMarriedIdAndDate(scheduleId,
        userMarriedId, day);
  }

  @Override
  public List<ScheduleMemory> findByMarriedIdWithCursor(Long marriedId, Long firstScheduleMemoryId,
      int size) {
    Pageable pageable = PageRequest.of(0, size);
    return scheduleMemoryJpaRepository.findByMarriedIdWithCursor(marriedId, firstScheduleMemoryId,
        pageable);
  }
