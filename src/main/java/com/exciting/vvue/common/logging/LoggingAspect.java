...
public class LoggingAspect {
  ...
  public Object logAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
    ...
    Timer timer = meterRegistry.timer("method_execution_time", "method", methodName, "type",
        pointcutName);
    Counter errorCounter = meterRegistry.counter("method_execution_error", "method", methodName,
        "type", pointcutName);

    long startTime = System.nanoTime();

    logger.info("[{}] {} started with arguments: {}", requestId, methodName,
  ...
  private String resolvePointcutName(ProceedingJoinPoint proceedingJoinPoint) {
    ...
    if (clazz.isAnnotationPresent(org.springframework.web.bind.annotation.RestController.class)
        || (superClass != null && superClass.isAnnotationPresent(
