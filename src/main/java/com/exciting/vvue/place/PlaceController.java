...
public class PlaceController {
  ...
  public ResponseEntity<RecommendPlaceListResDto> getRecommendPlace(@RequestParam double lat,
      @RequestParam double lng,
      @RequestParam Long distance, @RequestParam Long cursor, @RequestParam Long size) {
    Long userId = AuthContext.getUserId();
    RecommendPlaceListResDto recommendPlaceListResDto = placeService.getRecommendPlaces(userId, lat,
        lng, distance,
        cursor, size);
