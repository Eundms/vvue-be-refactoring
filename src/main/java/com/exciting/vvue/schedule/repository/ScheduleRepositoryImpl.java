...
public class ScheduleRepositoryImpl implements ScheduleRepository {
  ...
  @Override
  public List<Schedule> findByMarriedAndFuture(Long marriedId, int typeCursor, LocalDate dateCursor,
      long idCursor,
      int resultSize) {
    return scheduleJpaRepository.findByMarriedAndFuture(marriedId, typeCursor, dateCursor, idCursor,
        resultSize);
  }
  ...
  @Override
  public List<Schedule> findByMarriedIdAndDateTypeIn(long marriedId,
      List<DateType> checkDateTypes) {
